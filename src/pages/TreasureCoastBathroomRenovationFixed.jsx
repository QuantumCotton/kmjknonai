...
export default function TreasureCoastBathroomRenovationFixed(){
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center text-white">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Button
                onClick={() => openModalWithContext('Upload Bathroom Photos')}
                size="lg"
          ...
          <p className="mt-4 text-sm opacity-80">
            Share inspiration shots or existing bathroom photos when you text us for Treasure Coast scheduling priority.
          </p>
        </div>
      </section>
