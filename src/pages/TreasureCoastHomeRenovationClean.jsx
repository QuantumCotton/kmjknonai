...
export default function TreasureCoastHomeRenovationClean(){
  ...
  useEffect(() => {
    document.title = 'Home Renovation in Treasure Coast, FL | KMJK Home Improvement'
    const faq = {
      '@context': 'https://schema.org', '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'How long does a home renovation take?', acceptedAnswer: { '@type': 'Answer', text: 'Typical projects take 6–12 weeks depending on scope.' } },
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append('subject', 'Treasure Coast Home Renovation Consultation Request')
    formDataToSend.append('Landing Page', 'Treasure Coast Home Renovation')
    formDataToSend.append('Button Clicked', buttonContext || 'Schedule Consultation')
      ...
      if (data.success) {
        if (window.gtag) {
          window.gtag('event', 'generate_lead', {
            ...
            button_context: buttonContext || 'Schedule Consultation',
          })
        }
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center text-white">
          <div className="inline-block bg-[var(--brushed-gold)] text-[var(--deep-charcoal)] px-4 py-2 rounded-full text-sm font-semibold mb-4 shadow-md">
            Treasure Coast Signature Service • Projects from $40k+
          </div>
          <h1 className="text-4xl font-bold mb-3">Home Renovation in Treasure Coast, FL</h1>
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <Button
                onClick={() => openModalWithContext('Schedule Consultation')}
                size="lg"
                className="bg-white text-[var(--deep-charcoal)] hover:bg-gray-100"
              >
              ...
              <a
                href={SWAY_PHONE_CALL_LINK}
                className="flex items-center justify-center gap-2 bg-[var(--brushed-gold)] px-4 py-3 text-sm font-semibold text-[var(--deep-charcoal)] hover:bg-[var(--brushed-bronze)] transition-colors"
              >
                <Phone size={18} />
                Call {SWAY_CONTACT_NAME}
              </a>
              <a
                href={KMJK_PHONE_SMS_LINK}
                className="flex items-center justify-center gap-2 bg-[var(--deep-charcoal)] px-4 py-3 text-sm font-semibold text-white hover:bg-black transition-colors"
              >
                <MessageSquare size={18} />
                Text {KMJK_CONTACT_NAME}
              </a>
              <a
                href="mailto:info@kmjk.pro"
                className="flex items-center justify-center gap-2 bg-white/10 px-4 py-3 text-sm font-semibold text-white hover:bg-white hover:text-[var(--deep-charcoal)] transition-colors"
              >
                Email
              </a>
            </div>
          ...
          <p className="mt-6 text-sm opacity-90">
            Treasure Coast Custom Homes • KMJK
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start"><Check className="text-[var(--brushed-gold)] mr-2"/>Complete home renovations</li>
          ...
          <div>
            ...
            <div className="rounded-lg border p-4">
              <p className="mb-2"><strong>Kitchen + Bath Package:</strong> $40k - $80k</p>
              <p className="mb-2"><strong>Full Home Renovation:</strong> $85k - $150k</p>
              <p className="mb-2"><strong>Estate Transformation:</strong> $175k+</p>
              <p className="text-sm text-gray-600">Includes design consultation, project coordination, and white-glove installation.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Upload inspiration photos or existing home snapshots so our design team can prepare tailored concepts.
            </DialogDescription>
          </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div>
                ...
                <textarea
                  id="message"
                  rows="4"
                  placeholder="Tell us about the home spaces you'd like to transform, must-have features, design inspiration, etc."
