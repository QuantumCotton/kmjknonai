...
export default function TreasureCoastBathroomRenovationClean(){
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append('subject', 'Treasure Coast Bathroom Consultation Request')
    formDataToSend.append('Landing Page', 'Treasure Coast Bathroom Renovation')
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center text-white">
          <div className="inline-block bg-[var(--brushed-gold)] text-[var(--deep-charcoal)] px-4 py-2 rounded-full text-sm font-semibold mb-4 shadow-md">
            Treasure Coast Signature Service • Projects from $18k+
          </div>
          <h1 className="text-4xl font-bold mb-3">Bathroom Renovation in Treasure Coast, FL</h1>
          ...
          <p className="mt-6 text-sm opacity-90">
            Treasure Coast Custom Bathrooms • KMJK
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="rounded-lg border p-4">
              <p className="mb-2"><strong>Signature Suites:</strong> $18k - $32k</p>
              <p className="mb-2"><strong>Full Spa Retreat:</strong> $38k - $62k</p>
              <p className="mb-2"><strong>Estate Spa Experience:</strong> $70k+</p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700 italic mb-4">
              "Our Treasure Coast bathroom had to wow guests and survive coastal conditions. KMJK coordinated everything, protected every floor, and delivered a spa shower that feels like a luxury resort."
            </p>
            <div className="text-sm text-gray-600 font-semibold">- Dana & William L., Stuart</div>
          </div>
        </div>
      </section>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Upload inspiration photos or existing bathroom snapshots so our design team can prepare tailored concepts.
            </DialogDescription>
          </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div>
                ...
                <textarea
                  id="message"
                  rows="4"
                  placeholder="Tell us about the bathroom spaces you'd like to transform, must-have features, design inspiration, etc."
